page 9631 "Page Inspection"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(Control26)
            {
                ShowCaption = false;
                Visible = true;
                field(OpenInVsCodeTextLbl; OpenInVsCodeTextLbl)
                {
                    AccessByPermission = System "Tools, Zoom" = X;
                    ApplicationArea = All;
                    DrillDown = true;
                    ExtendedDatatype = URL;
                    ShowCaption = false;
                    ToolTip = 'Specifies the URL that opens this page in Visual Studio Code.';
    ...
    var
        ...
        OpenInVsCodeTextLbl: Label 'Open page in Visual Studio Code';
        ShowFields: Boolean;
    ...
    var
        VSCodeRequestHelper: Codeunit "VSCode Request Helper";
    begin
        OpenInVsCoderequestURL := VSCodeRequestHelper.GetUrlToNavigatePageInVSCode(Rec."Page ID", Rec."Page Name");
    end;
