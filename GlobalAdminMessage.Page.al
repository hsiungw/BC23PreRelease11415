...
page 1459 "Global Admin Message"
{
    ...
    var
        ...
        GlobalAdminLbl: Label 'Global Administrator', Comment = 'Refers to the Global Administrator role of AAD';
        D365AdminLbl: Label 'Dynamics 365 Administrator', Comment = 'Refers to the Dynamics 365 Administrator role of AAD';
        TitleTxt: Text;
        IconVisible: Boolean;
}