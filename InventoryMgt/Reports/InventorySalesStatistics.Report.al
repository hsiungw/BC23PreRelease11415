report 712 "Inventory - Sales Statistics"
{
    ...
    begin
        ...
        ItemStatisticsBuffer.SetRange("Item Ledger Entry Type Filter", "Item Ledger Entry Type"::Sale);
        ItemStatisticsBuffer.SetFilter("Entry Type Filter", '<>%1', "Cost Entry Type"::Revaluation);
    end;
