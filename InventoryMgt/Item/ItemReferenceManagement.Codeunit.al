codeunit 5720 "Item Reference Management"
{
    ...
    begin
        ...
        if IsHandled then
            exit;
        FindOrSelectFromItemReferenceList(ReturnedItemReference, ShowDialog, PhysInvtOrderLine."Item No.", PhysInvtOrderLine."Item Reference No.", '', ReturnedItemReference."Reference Type"::" ");
    end;
    ...
    begin
        ...
        if IsHandled then
            exit;
        FindOrSelectFromItemReferenceList(ReturnedItemReference, ShowDialog, PhysInvtRecordLine."Item No.", PhysInvtRecordLine."Item Reference No.", '', ReturnedItemReference."Reference Type"::" ");
    end;
    ...
    begin
        ...
        if IsHandled then
            exit;
        FindOrSelectFromItemReferenceList(ReturnedItemReference, ShowDialog, ItemJournalLine."Item No.", ItemJournalLine."Item Reference No.", '', ReturnedItemReference."Reference Type"::" ");
    end;
