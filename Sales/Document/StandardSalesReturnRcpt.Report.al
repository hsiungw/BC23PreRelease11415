report 1309 "Standard Sales - Return Rcpt."
{
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Sales/Document/StandardSalesReturnRcpt.rdlc';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesReturnRcpt.docx';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesReturnRcptBlue.docx';
