report 1306 "Standard Sales - Invoice"
{
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Sales/Document/StandardSalesInvoice.rdlc';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesInvoice.docx';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesInvoiceBlueSimple.docx';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesInvoiceVatSpec.docx';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesInvoiceDefEmail.docx';
