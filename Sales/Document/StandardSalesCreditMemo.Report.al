report 1307 "Standard Sales - Credit Memo"
{
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Sales/Document/StandardSalesCreditMemo.rdlc';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesCreditMemo.docx';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesCreditMemoEmail.docx';
