report 1308 "Standard Sales - Shipment"
{
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Sales/Document/StandardSalesShipment.rdlc';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesShipment.docx';
        ...
        {
            Type = Word;
            LayoutFile = './Sales/Document/StandardSalesShipmentBlue.docx';
