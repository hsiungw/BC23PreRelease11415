codeunit 99000832 "Sales Line-Reserve"
{
    ...
    begin
        ...
        if SalesLine."Drop Shipment" then begin
            ...
            if SalesLine."Purchase Order No." <> '' then
                ItemTrackingLines.SetSecondSourceRowID(ItemTrackingManagement.ComposeRowID(DATABASE::"Purchase Line",
    ...
    begin
        with WarehouseShipmentLine do begin
            ...
            exit(FindFirst() and NewReservationEntry.Get(OldReservationEntry."Entry No.", not OldReservationEntry.Positive) and
              (OldReservationEntry."Reservation Status" = OldReservationEntry."Reservation Status"::Reservation) and
              (NewReservationEntry."Source Type" <> DATABASE::"Item Ledger Entry") and ("Qty. Picked (Base)" >= TransferQty));
        end;
    end;
