codeunit 5991 "Sales Warehouse Mgt."
{
...
#endif
            OnAfterInitNewWhseShptLine(WarehouseShipmentLine, WarehouseShipmentHeader, SalesLine, AssembleToOrder);
    ...
    begin
        CheckIfFromSalesLine2ShptLine(SalesLine, "Reservation From Stock"::" ");
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitNewWhseShptLine(var WarehouseShipmentLine: Record "Warehouse Shipment Line"; WarehouseShipmentHeader: Record "Warehouse Shipment Header"; SalesLine: Record "Sales Line"; AssembleToOrder: Boolean)
    begin
    end;
