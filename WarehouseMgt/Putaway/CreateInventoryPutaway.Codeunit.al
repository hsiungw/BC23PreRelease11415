codeunit 7321 "Create Inventory Put-away"
{
            ...
            if not IsHandled and PurchaseLine.IsInventoriableItem() then
                if not NewWarehouseActivityLine.ActivityExists(DATABASE::"Purchase Line", PurchaseLine."Document Type".AsInteger(), PurchaseLine."Document No.", PurchaseLine."Line No.", 0, 0) then begin
                    ...
                    case CurrLocation."Put-away Bin Policy" of
                        "Put-away Bin Policy"::"Default Bin":
                            begin
                        ...
                        "Put-away Bin Policy"::"Put-away Template":
                            begin
                    ...
                    if CurrLocation."Always Create Put-away Line" and (RemQtyToPutAway > 0) then
                        repeat
        ...
        repeat
            ...
            if not IsHandled and SalesLine.IsInventoriableItem() then
                if not NewWarehouseActivityLine.ActivityExists(DATABASE::"Sales Line", SalesLine."Document Type".AsInteger(), SalesLine."Document No.", SalesLine."Line No.", 0, 0) then begin
                    ...
                    if CurrLocation."Always Create Put-away Line" and (RemQtyToPutAway > 0) then
                        repeat
                            CreateWarehouseActivityLine(DATABASE::"Sales Line", SalesLine."Document Type".AsInteger(), SalesLine."Document No.", SalesLine."Line No.",
    ...
    begin
        ...
        repeat
            ...
            CreateWarehouseActivityLine(DATABASE::"Sales Line", SalesLineToPutaway."Document Type".AsInteger(), SalesLineToPutaway."Document No.", SalesLineToPutaway."Line No.",
    ...
    begin
        CreatePutawayWithPutawayTemplateBinPolicy(Database::"Sales Line", SalesLineToPutaway."Document Type".AsInteger(), SalesLineToPutaway."Document No.", SalesLineToPutaway."Line No.",
        ...
        repeat
            ...
            if not IsHandled then
                if not NewWarehouseActivityLine.ActivityExists(DATABASE::"Transfer Line", 1, TransferLine."Document No.", TransferLine."Line No.", 0, 0) then begin
                    ...
                    if CurrLocation."Always Create Put-away Line" and (RemQtyToPutAway > 0) then
                        repeat
                            CreateWarehouseActivityLine(DATABASE::"Transfer Line", 1, TransferLine."Document No.", TransferLine."Line No.",
    ...
    begin
        ...
        repeat
            ...
            CreateWarehouseActivityLine(DATABASE::"Transfer Line", 1, TransferLineToPutaway."Document No.", TransferLineToPutaway."Line No.",
    ...
    begin
        CreatePutawayWithPutawayTemplateBinPolicy(Database::"Transfer Line", 1, TransferLineToPutaway."Document No.", TransferLineToPutaway."Line No.",
        ...
        repeat
            ...
            if not IsHandled then
                if not NewWarehouseActivityLine.ActivityExists(DATABASE::"Prod. Order Line", ProdOrderLine.Status.AsInteger(), ProdOrderLine."Prod. Order No.", ProdOrderLine."Line No.", 0, 0) then begin
                    ...
                    if CurrLocation."Always Create Put-away Line" and (RemQtyToPutAway > 0) then
                        repeat
                            CreateWarehouseActivityLine(DATABASE::"Prod. Order Line", ProdOrderLine.Status.AsInteger(), ProdOrderLine."Prod. Order No.", ProdOrderLine."Line No.",
    ...
    begin
        ...
        repeat
            ...
            CreateWarehouseActivityLine(DATABASE::"Prod. Order Line", ProdOrderLineToPutaway.Status.AsInteger(), ProdOrderLineToPutaway."Prod. Order No.", ProdOrderLineToPutaway."Line No.",
    ...
    begin
        ...
        CreatePutawayWithPutawayTemplateBinPolicy(Database::"Prod. Order Line", 1, ProdOrderLineToPutaway."Prod. Order No.", ProdOrderLineToPutaway."Line No.",
        ...
        repeat
            ...
            if not IsHandled then
                ...
                then begin
                    ...
                    if CurrLocation."Always Create Put-away Line" and (RemQtyToPutAway > 0) then
                        repeat
                            CreateWarehouseActivityLine(DATABASE::"Prod. Order Component", ProdOrderComponent.Status.AsInteger(), ProdOrderComponent."Prod. Order No.", ProdOrderComponent."Line No.",
    ...
    begin
        ...
        CreatePutawayWithPutawayTemplateBinPolicy(Database::"Prod. Order Component", 1, ProdOrderComponent."Prod. Order No.", ProdOrderComponent."Line No.",
    ...
    begin
        ...
        ProdOrderComponent.SetRange("Flushing Method", "Flushing Method"::Manual);
    ...
    begin
        CurrWarehouseRequest := NewWarehouseRequest;
        if CurrLocation.RequireReceive(CurrWarehouseRequest."Location Code") and
           (CurrWarehouseRequest."Source Document" <> CurrWarehouseRequest."Source Document"::"Prod. Output")
        then
            exit(false);
