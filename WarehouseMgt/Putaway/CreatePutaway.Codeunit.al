codeunit 7313 "Create Put-away"
{
    ...
    var
        ...
        NotEnoughCapacityMsg: Label 'There is not enough bin capacity for items.';
    ...
    begin
        ...
        if QtyToPickBase > 0 then begin
            ...
            CreateNewWhseActivity(
                  PostedWhseReceiptLine, CurrWarehouseActivityLine, "Warehouse Action Type"::Take, TakeLineNo, 0, QtyToPickBase, false, BreakPackage, false, Breakbulk);
            ...
            if MessageText = '' then
                if CurrLocation."Directed Put-away and Pick" then
                    MessageText := NotEnoughCapacityMsg
                else
    ...
    begin
        ...
        CreateNewWhseActivity(
          PostedWhseReceiptLine, TempWarehouseActivityLine, "Warehouse Action Type"::Take, LineNo,
          BreakbulkNo, PostedWhseReceiptLine."Qty. (Base)", false, true, false, false);
        LineNo := LineNo + 10000;
        CreateNewWhseActivity(
          PostedWhseReceiptLine, TempWarehouseActivityLine, "Warehouse Action Type"::Place, LineNo,
    ...
    begin
        if CurrLocation."Bin Mandatory" then begin
            ...
            if not EmptyZoneBin and CurrLocation."Directed Put-away and Pick" then
