codeunit 7322 "Create Inventory Pick/Movement"
{
    ...
    begin
        ...
        case CurrWarehouseRequest."Source Document" of
            ...
            CurrWarehouseRequest."Source Document"::"Assembly Consumption":
                begin
                    CurrAssemblyHeader.Get(CurrWarehouseRequest."Source Subtype", CurrWarehouseRequest."Source No.");
                    PostingDate := CurrAssemblyHeader."Posting Date";
                end;
            CurrWarehouseRequest."Source Document"::"Job Usage":
                CurrJob.Get(CurrWarehouseRequest."Source No.");
            else
                OnGetSourceDocHeaderFromWhseRequest(CurrWarehouseRequest, SourceDocRecordRef, PostingDate, VendorDocNo);
        end;
        ...
        with PurchaseLine do begin
            ...
            repeat
                ...
                if not IsHandled and IsInventoriableItem() then
                    if not NewWarehouseActivityLine.ActivityExists(DATABASE::"Purchase Line", "Document Type".AsInteger(), "Document No.", "Line No.", 0, 0) then begin
                        ...
                        NewWarehouseActivityLine.SetSource(DATABASE::"Purchase Line", "Document Type".AsInteger(), "Document No.", "Line No.", 0);
        ...
        with SalesLine do begin
            ...
            repeat
                ...
                if not IsHandled and CanPickSalesLine(SalesLine) then
                    if not NewWarehouseActivityLine.ActivityExists(DATABASE::"Sales Line", "Document Type".AsInteger(), "Document No.", "Line No.", 0, 0) then begin
                        NewWarehouseActivityLine.Init();
                        NewWarehouseActivityLine."Activity Type" := CurrWarehouseActivityHeader.Type;
                        NewWarehouseActivityLine."No." := CurrWarehouseActivityHeader."No.";
                        if CurrLocation."Bin Mandatory" then
                            NewWarehouseActivityLine."Action Type" := NewWarehouseActivityLine."Action Type"::Take;
                        NewWarehouseActivityLine.SetSource(DATABASE::"Sales Line", "Document Type".AsInteger(), "Document No.", "Line No.", 0);
                        NewWarehouseActivityLine."Location Code" := "Location Code";
                        NewWarehouseActivityLine."Bin Code" := "Bin Code";
                        NewWarehouseActivityLine."Item No." := "No.";
                        NewWarehouseActivityLine."Variant Code" := "Variant Code";
            ...
            repeat
                ...
                if not IsHandled then
                    ...
                    then begin
                        ...
                        if CurrLocation."Bin Mandatory" then
                            NewWarehouseActivityLine."Action Type" := NewWarehouseActivityLine."Action Type"::Take;
                        NewWarehouseActivityLine.SetSource(DATABASE::"Prod. Order Component", Status.AsInteger(), "Prod. Order No.", "Prod. Order Line No.", "Line No.");
                        NewWarehouseActivityLine."Location Code" := "Location Code";
                        NewWarehouseActivityLine."Bin Code" := "Bin Code";
                        NewWarehouseActivityLine."Item No." := "Item No.";
                        NewWarehouseActivityLine."Variant Code" := "Variant Code";
    ...
    begin
        with AssemblyLine do begin
            ...
            if CurrWarehouseActivityHeader.Type = CurrWarehouseActivityHeader.Type::"Invt. Pick" then // no support for inventory pick on assembly
                exit;
            ...
            repeat
                ...
                if not IsHandled then
                    if not
                       NewWarehouseActivityLine.ActivityExists(DATABASE::"Assembly Line", "Document Type".AsInteger(), "Document No.", "Line No.", 0, 0)
                    then begin
                        NewWarehouseActivityLine.Init();
                        NewWarehouseActivityLine."Activity Type" := CurrWarehouseActivityHeader.Type;
                        NewWarehouseActivityLine."No." := CurrWarehouseActivityHeader."No.";
                        if CurrLocation."Bin Mandatory" then
                            NewWarehouseActivityLine."Action Type" := NewWarehouseActivityLine."Action Type"::Take;
                        NewWarehouseActivityLine.SetSource(DATABASE::"Assembly Line", "Document Type".AsInteger(), "Document No.", "Line No.", 0);
                        NewWarehouseActivityLine."Location Code" := "Location Code";
                        NewWarehouseActivityLine."Bin Code" := "Bin Code";
                        NewWarehouseActivityLine."Item No." := "No.";
                        NewWarehouseActivityLine."Variant Code" := "Variant Code";
    ...
    local procedure MakeLineWhenSNoReq(var NewWarehouseActivityLine: Record "Warehouse Activity Line"; TakeBinCode: Code[20]; QtyToPickBase: Decimal; var RemQtyToPickBase: Decimal; var RemQtyToPick: Decimal)
    var
