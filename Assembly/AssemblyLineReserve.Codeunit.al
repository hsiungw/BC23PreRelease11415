codeunit 926 "Assembly Line-Reserve"
{
    ...
    begin
        with NewAssemblyLine do begin
            ...
            ReservationManagement.DeleteReservEntries(false, "Remaining Quantity (Base)");
            ReservationManagement.ClearSurplus();
            ReservationManagement.AutoTrack("Remaining Quantity (Base)");
            AssignForPlanning(NewAssemblyLine);
        end;
    end;
    ...
    begin
        ...
        with TempEntrySummary do
            if TotalQuantity < 0 = Positive then begin
                ...
                "Summary Type" := CopyStr(StrSubstNo(SummaryTypeTxt, AssemblyLine.TableCaption(), AssemblyLine."Document Type"),
