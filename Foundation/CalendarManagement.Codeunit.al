codeunit 7600 "Calendar Management"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCalcDateBOCOnBeforeCalcNewDate(OrgDateExpression: Text[30]; OrgDate: Date; var CustomCalendarChange: Array[2] of Record "Customized Calendar Change"; CheckBothCalendars: Boolean; var NewDate: Date; var IsHandled: Boolean)
    begin
    end;
}
