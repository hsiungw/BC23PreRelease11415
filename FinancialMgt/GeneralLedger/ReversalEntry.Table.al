table 179 "Reversal Entry"
{
    ...
    begin
        ...
        if not DetailedCustLedgEntry.IsEmpty() then
            Error(Text013, CustLedgerEntry.TableCaption(), CustLedgerEntry."Entry No.");
    ...
    begin
        ...
        if not DetailedVendorLedgEntry.IsEmpty() then
            Error(Text013, VendorLedgerEntry.TableCaption(), VendorLedgerEntry."Entry No.");
    ...
    begin
        ...
        "FA Posting Type" := "Reversal Entry FA Posting Type".FromInteger(FALedgerEntry."FA Posting Type".AsInteger() + 1);
