codeunit 5996 "Prod. Order Warehouse Mgt."
{
    ...
    var
        ...
        ProdOrderComponent: Record "Prod. Order Component";
    begin
        if ItemJournalLine."Order Type" = "Inventory Order Type"::Production then begin
            if (ItemJournalLine."Entry Type" = "Item Ledger Entry Type"::Output) then
            ...
            if (ItemJournalLine."Entry Type" = "Item Ledger Entry Type"::Consumption) then
    ...
    begin
        with PlanningRoutingLine do begin
            ...
            if FindLast() then
                exit(GetProdCenterBinCode(Type, "No.", LocationCode, false, "Flushing Method Routing"::Manual));
        end;
    end;
        ...
        if ProdOrderRoutingLine.FindLast() then
            exit(
                GetProdCenterBinCode(
                    ProdOrderRoutingLine.Type, ProdOrderRoutingLine."No.", LocationCode, false, "Flushing Method"::Manual));
    end;
    ...
    begin
        case WarehouseRequest."Source Document" of
            "Warehouse Request Source Document"::"Prod. Consumption", "Warehouse Request Source Document"::"Prod. Output":
                begin
