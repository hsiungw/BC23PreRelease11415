...
{
    PageType = List;
    Caption = 'Dataverse Available Virtual Tables';
            ...
            action("Open in Dataverse")
            {
                ...
                begin
                    if CDSConnectionSetup.Get() then
                        EntityListUrl := CDSIntegrationImpl.GetCRMEntityListUrl(CDSConnectionSetup, VirtualTableEntityNameTxt, VirtualTableAppIdTxt);
    ...
    var
        ...
        VirtualTableAppIdTxt: Label '7d8e48c4-760c-ee11-8f6e-000d3a8fbbc3', Locked = true;
