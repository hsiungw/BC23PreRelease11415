codeunit 7201 "CDS Integration Impl."
{
    ...
    var
        ...
        CRMEntityListWithAppUrlTemplateTxt: Label '%1/main.aspx?appid=%2&pagetype=entitylist&etn=%3&navbar=on&cmdbar=true', Locked = true;
    ...
    internal procedure GetCRMEntityListUrl(var CDSConnectionSetup: Record "CDS Connection Setup"; EntityTypeName: Text; AppId: Text): Text
    begin
        if AppId <> '' then
            exit(StrSubstNo(CRMEntityListWithAppUrlTemplateTxt, CDSConnectionSetup."Server Address", AppId, EntityTypeName))
        else
